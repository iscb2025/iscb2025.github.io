...
The closing date for applications is the same as the general abstract deadline (see the [key dates page](key-dates.qmd)).
...
(a) A short abstract of the paper prepared according to the ISCB standard conference format, uploaded via the ISCB 2025 Abstract Submission Portal in the "Abstracts" track, **with the "StCA" award checkbox selected**.
...
**The two files containing (b) and (c) should be uploaded via the [conference abstract handling system](https://www.conftool.org/iscb2025) by submitting to the Student Award track**.
