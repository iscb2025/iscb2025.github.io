...
<!-- Dial-in links will be provided about one week prior to the conference. -->
...
## Can I update my contribution (list of authors, title, etc.)
...
We have hundreds of contributions and the Scientific Committee has very diligently put together a scientific program. We hope it is understandable that we are not able to accommodate requests for moves of contributions to other time slots. Reasons are:

- Poster panels are numbered and we use all of them. If we move a poster we would have to move another one, and that may interfere with that other contributor's travel plans. 
...
## When will recordings be available online?

A few days after the conference.

## Will we be notified when the are available online?
